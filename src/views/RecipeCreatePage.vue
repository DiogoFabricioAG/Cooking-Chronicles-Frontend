        ...
        <div class="md:w-1/3">
            ...
            >
                ...
                <input
                    ...
                    v-model="name"
                    id="name"
                    class="w-full px-4 py-1 rounded-xl border border-black"
                />
                <label for="name" class="block text-sm font-esteban text-gray-500"
                    >Imagen de la Receta</label
                >
                <input
                    ...
                    type="file"
                />
                <label for="descr" class="block text-sm font-esteban text-gray-500"
                    >Descripcion General</label
                >
                <textarea
                    name="descr"
                    v-model="description"
                    class="w-full px-2 py-1 rounded-xl resize-none border border-black"
                    id="descr"
                    cols="30"
                    rows="6"
                ></textarea>
                <label for="selfopi" class="block text-sm font-esteban text-gray-500"
                    >Opinion Propia</label
                >
                <textarea
                    name="selfopi"
                    v-model="user_impressions"
                    class="w-full px-2 py-1 rounded-xl resize-none border border-black"
                    id="selfopi"
                    cols="30"
                    rows="6"
